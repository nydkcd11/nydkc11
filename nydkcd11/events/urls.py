...
urlpatterns= [
	...
	url(r'^long_event/(?P<convention_id>[0-9]+)/(?P<slug>[\w-]+)/$', views.long_event, name = 'long_event'),
	url(r'^long_event/(?P<convention_id>[0-9]+)/$', views.long_event_redirect, name = 'long_event_redirect'),
